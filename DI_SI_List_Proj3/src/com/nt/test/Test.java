...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(emp.getSalary().getClass()); //print the class name
		System.out.println(emp.getSalary());
		System.out.println(emp.getSalary().get(2)); //print only index value 
		
		System.out.println("salary Iterator ::");
		emp.showList();
