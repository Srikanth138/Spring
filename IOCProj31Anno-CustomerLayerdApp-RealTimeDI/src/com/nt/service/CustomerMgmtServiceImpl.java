...
//@Service("custService")
@Component("custService") //componet mean give "id" name of class object name in .xml file
public final class CustomerMgmtServiceImpl implements ICustomerMgmtService {
	...
	@Override
	public String calculateSimpleIntrestAmount(CustomerDTO dto)
			throws Exception {
		// write b.logic to calculate simple intrAmount based on pAmt,rate,time
		float intrAmt = (dto.getPAmt() * dto.getRate() * dto.getTime())
				/ 100.0f;
		...
		return count == 0
				...
				: "Customer Registration Succeded:: Details are :: principlet amount::"
						+ dto.getPAmt() + "Time:: " + dto.getTime() + " rate::"
						+ dto.getRate() + " Intrest amount:: " + intrAmt;
	}
