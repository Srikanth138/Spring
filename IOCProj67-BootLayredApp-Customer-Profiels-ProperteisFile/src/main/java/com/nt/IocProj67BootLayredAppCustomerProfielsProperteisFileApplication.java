...
public class IocProj67BootLayredAppCustomerProfielsProperteisFileApplication {
	@Autowired
	...
	public DataSource createC3PODS() throws Exception {
		System.out.println(
				"IocProj64BootLayredAppCustomerApplication.createC3PODS()");
	...
	public static void main(String[] args) {
		...
		try {
			...
			CustomerVO custVO = new CustomerVO("raja", "hyd", "100000", "2",
					"12");
			// invoke methods
		...
		System.out.println("active profile is ::"
