    ...
    <table  border="1" bgcolor="pink" align="center">
       ...
       <c:forEach  var="emp" items="${empsList}">
          <tr>
              ...
              <td>${emp.esalary}  </td>
              <td>
               <a href="edit?no=${emp.eno}"><img src="images/edit.jpg" width="50px;" height="50px;" alt="edit"> </a>
               <a href="delete?no=${emp.eno}" onclick="return confirm(' Do u want to delete?')"><img src="images/delete.jfif" width="50px;" height="50px;" alt="delete"> </a>
                </td>
          </tr>
       </c:forEach>
    </table>
