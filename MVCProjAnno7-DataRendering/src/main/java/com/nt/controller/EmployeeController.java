...
//		  listDTO.add(new EmployeeDTO(901,"ramesh","hyd",6676.0f));

		  List<EmployeeDTO>  listDTO=List.of(new EmployeeDTO(901,"ramesh","hyd",6676.0f),new EmployeeDTO(902,"suresh","vizag",6761.0f),new EmployeeDTO(903,"jani","delhi",47761.0f));
