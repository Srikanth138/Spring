...
public class SpringDataJpaProj11WorkingWithLoBsApplication {

	public static void main(String[] args) {
		// get IOC container
		ApplicationContext ctx = SpringApplication.run(SpringDataJpaProj11WorkingWithLoBsApplication.class, args);
...
//		String photoLocation = sc.next(); // C:\Users\srika\Pictures\home.jpg
//		System.out.println("Enter jobSeeker resumeLocation");
//		String resumeLocation = sc.next(); // ‪ C:\Users\srika\Desktop\text.txt
//		try {
...
//			dto.setJsName(name);
//			dto.setQlfy(qlfy);
//			dto.setPhoto(photoContent);
//			dto.setResume(resumeContent);
//			dto.setStatus(true);
//
...
//		}
		...
		try {
			System.out.println("---------------------------------------");
			JobSeekerDTO dto1 = service.getJobSeekerInfoById(1);
			if (dto1 != null) {
