...
public class SpringDataJpaProj4FinderMehodsEntityOperationsApplication {

	public static void main(String[] args) {
		// get IOC container
		ApplicationContext ctx = SpringApplication.run(SpringDataJpaProj4FinderMehodsEntityOperationsApplication.class,
				args);
...
//		repo.findByEaddIn(List.of("hyd", "mumbai", "delhi")).forEach(System.out::println);// List.of() java9 featurt

//		 repo.findByEaddNotIn(List.of("hyd","mumbai")).forEach(System.out::println); //List.of() java9 featurt
...
//		 repo.findByEnameStartingWithAndEaddStartingWith("r","h").forEach(System.out::println);
		 ...
		 repo.findByEnoGreaterThanEqualAndEnameEndingWithOrEsalaryBetween(100,
		 "a",10000, 20000).forEach(System.out::println);
