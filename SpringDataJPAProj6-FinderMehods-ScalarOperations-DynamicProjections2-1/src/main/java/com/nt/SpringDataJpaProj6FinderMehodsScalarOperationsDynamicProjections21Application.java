...
public class SpringDataJpaProj6FinderMehodsScalarOperationsDynamicProjections21Application {

	public static void main(String[] args) {
		// get IOC container
		ApplicationContext ctx = SpringApplication
				.run(SpringDataJpaProj6FinderMehodsScalarOperationsDynamicProjections21Application.class, args);
		...
		list4.forEach(view4->{
			 System.out.println(view4.getEname()+" "+view4.getEsalary());
		});
	}
