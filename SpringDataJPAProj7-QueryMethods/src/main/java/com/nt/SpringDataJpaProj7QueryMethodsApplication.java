...
public class SpringDataJpaProj7QueryMethodsApplication {

	public static void main(String[] args) {
		//get IOC container
				ApplicationContext ctx=SpringApplication.run(SpringDataJpaProj7QueryMethodsApplication.class, args);
...
//				repo.fetchAllEmployeeBySalaryRange(1000, 20000).forEach(System.out::println);
...
//				 System.out.println("details are::"+row[0]+"  "+row[1]); 
				...
				/*
				 * float salary=repo.findEmpSalaryByEno(1);
