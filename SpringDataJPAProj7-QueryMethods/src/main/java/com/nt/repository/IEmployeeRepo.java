...
//	@Query("SELECT  * FROM  Employee e ")
	...
	// ------------------------- Retrieving specific multiple col values (scalar
	// /Projections in BulkSelect ) --------------------------
	...
	// ------------------------- Retrieving specific single col values (scalar
	// /Projections in BulkSelect ) --------------------------
	...
	// ------------------------- Retrieving all col values of single row (Entity
	// Operation in SingleRow Select query ) --------------------------
	@Query(" FROM  Employee WHERE eno=:no")
	public Employee findEmpAllDetailsByEno(int no);

	// ------------------------- Retrieving specific multiple col values of
	// singlerow (scalar/Projection Operation in SingleRow Select query )
	// --------------------------
	@Query("SELECT eno,eadd FROM  Employee WHERE eno=:no")
	public Object findEmpPartialDetailsByEno(int no);

	// ------------------------- Retrieving specific single col value of singlerow
	// (sclar/Projection Operation in SingleRow Select query )
	// --------------------------
