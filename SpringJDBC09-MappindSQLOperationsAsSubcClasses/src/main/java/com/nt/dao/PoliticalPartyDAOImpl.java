...
public class PoliticalPartyDAOImpl implements IPoliticalPartyDAO {
	...
	public PoliticalPartyDAOImpl(DataSource ds) {
		...
		updator1 = new PoliticalPartyUpdator1(ds,
				UPDATE_FLAGCOLORS_BY_PARTYNAME);
	}
	...
	@Override
	public List<PoliticalParty> getPoliticalPartiesByPartyNames(
			String partyName1, String partyName2, String partyName3) {
		List<PoliticalParty> list = selector2.execute(partyName1, partyName2,
				partyName3);
		return list;
	}
	@Override
	public int updateFlagColorsByPartyName(String partyName,
			String flagColors) {
	...
	private static class PoliticalPartySelector1
			extends
				MappingSqlQuery<PoliticalParty> {
		...
		@Override
		public PoliticalParty mapRow(ResultSet rs, int rowNum)
				throws SQLException {
	...
	// inner class cum sub class1
	private static class PoliticalPartySelector2
			extends
				MappingSqlQuery<PoliticalParty> {
