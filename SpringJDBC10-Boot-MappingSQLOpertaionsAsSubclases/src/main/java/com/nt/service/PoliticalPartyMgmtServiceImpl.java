...
public class PoliticalPartyMgmtServiceImpl
		implements
			IPoliticalPartyMgmtService {
	@Autowired
	...
	@Override
	public List<PoliticalParty> fetchPoliticalPartiesDetailsByPartyNames(
			String partyName1, String partyName2, String partyName3) {
		// use DAO
		List<PoliticalParty> list = dao.getPoliticalPartiesByPartyNames(
	...
	public String modifyFlagColorsByPartyName(String newColors,
		...
		return count == 0
				? "Party Not found"
				: "PartyFound and flag colors are updated";
	}
