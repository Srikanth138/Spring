...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	public Float getEmployeeSalaryByEno(int eno) {
		float salary = jt.queryForObject(GET_EMP_SALARY_BY_EMPNO, Float.class,
				eno);
		return salary;
	}
	...
	public Map<String, Object> getEmployeeDetailsByEno(int eno) {
		Map<String, Object> map = jt.queryForMap(GET_EMP_DETTAILS_BY_EMPNO,
				eno);
		return map;
	}

	@Override
	public List<Map<String, Object>> getEmployeeDetailsByDesgs(String desg1,
			String desg2, String desg3) {
		List<Map<String, Object>> list = jt
				.queryForList(GET_EMP_DETTAILS_BY_DESGS, desg1, desg2, desg3);
		return list;
	}

	@Override
	public SqlRowSet getEmployeeDetailsBySalaryRange(float startSalary,
			float endSalary) {
		SqlRowSet rowset = jt.queryForRowSet(GET_EMP_DETTAILS_BY_SALRANGE,
